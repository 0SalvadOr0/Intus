          ...
          <div className="mb-12 md:mb-16">
            ...
            <div className={`text-xl md:text-2xl lg:text-3xl text-muted-foreground max-w-5xl mx-auto leading-relaxed px-4 space-y-6 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`} style={{transitionDelay: '0.3s'}}>
              <p className="animate-slide-in-left" style={{animationDelay: '0.5s'}}>
                Fondata nel <strong className="text-primary bg-primary/10 px-2 py-1 rounded-lg animate-glow hover:scale-110 transition-all duration-300 cursor-default">1997</strong> durante la <em className="text-accent">"Primavera Corleonese"</em>, promuove la <strong className="text-accent bg-accent/10 px-2 py-1 rounded-lg">legalità</strong>, i <strong className="text-primary">diritti umani</strong> e la <strong className="text-heart bg-heart/10 px-2 py-1 rounded-lg">cittadinanza attiva</strong>.
              </p>
