	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'fade-in-right': 'fade-in-right 1s ease both',
				'fade-in-left': 'fade-in-left 1s ease both',
				...
				'text-flicker': 'text-flicker 0.2s ease-in-out infinite',
				'parallax-drift': 'parallax-drift 10s ease-in-out infinite alternate'
			}
		}
	},
